...
public interface EvaluationDao {
    ...
    @Insert("insert into evaluation"
                    + "(evaluation_people_no,course_id,evaluation_time,evaluation_type,evaluation_score,evaluation_advice) "
    ...
    @Select("SELECT evaluation_id,evaluation_people_no,"
                    ...
                    + "evaluation_time,evaluation_type,evaluation_score,evaluation_advice FROM evaluation e where evaluation_type=0 "
                    + "or evaluation_type=1; ")
    ...
    @Select("SELECT evaluation_id,evaluation_people_no,"
                    ...
                    + "course_id,( SELECT course_name FROM course c WHERE c.course_id = e.course_id ) AS course_name,"
                    + "evaluation_time,evaluation_type,evaluation_score,evaluation_advice FROM evaluation e where evaluation_type=2; ")
     ...
     * 导入评价
     */
    @Insert("insert into evaluation(evaluation_people_no,course_id,evaluation_time,evaluation_score,evaluation_advice,evaluation_type) " +
            "values(#{bean.evaluationPeopleNo},#{bean.courseId},#{bean.evaluationTime},#{bean.evaluationScore},#{bean.evaluationAdvice},#{bean.evaluationType});")
