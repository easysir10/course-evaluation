...
public interface StudentDao {
    ...
    StudentBean loginCheck(@Param("studentNo") int studentNo,
    ...
    int updatePasswd(@Param("studentNo") int studentNo,
    ...
    @Update("update student set student_no=#{studentBean.studentNo}," +
            "student_name=#{studentBean.studentName}," +
            "student_gender=#{studentBean.studentGender}," +
            "student_dorm_no=#{studentBean.studentDormNo}," +
            "student_card_no=#{studentBean.studentCardNo}," +
            "student_phone=#{studentBean.studentPhone}," +
            "student_password=#{studentBean.studentPassword}," +
            "institute_id=#{studentBean.instituteId}," +
    ...
    @Select("select * from course c,course_type ct,student_course sc,teacher_course tc,teacher t " +
            " where c.type_id=ct.type_id and sc.mid_id=tc.mid_id and sc.student_id=#{id} " +
            "and c.course_id=tc.course_id and t.teacher_id=tc.teacher_id;")
