        ...
        k.prototype = {
            ...
            setSize: function() {
                ...
                if (this.options.size === "auto") {
                    ...
                    if (this.options.size && this.options.size != "auto" && this.$lis.not(E).length > this.options.size) {
                        var C = this.$lis.not(".dropdown-divider").not(E).children().slice(0, this.options.size).last().parent().student_index(),
            ...
            keydown: function(x) {
                ...
                if (/(38|40)/.test(x.keyCode.toString(10))) {
                    ...
                    if (!u.options.liveSearch) {
                        v = w.student_index(w.filter(":focus"))
                    } else {
                        v = w.student_index(w.filter(".active"))
                    }
